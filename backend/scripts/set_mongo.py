...
interprétation par le shell) :
    ...
    python backend/scripts/set_mongo.py <user> '<mot_de_passe>' [host]

Exemple :
    python backend/scripts/set_mongo.py mon_user 'MonMotDePasse123' cluster0.xxxx.mongodb.net
...
ENV = Path(__file__).resolve().parents[2] / ".env"  # .env à la racine du dépôt

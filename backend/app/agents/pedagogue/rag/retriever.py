"""Corpus search: embed question, rank by relevance + source authority."""
from __future__ import annotations

from app.agents.pedagogue.rag import embeddings, vectorstore
from app.agents.pedagogue.rag.ingest import is_stale
from app.config import settings


def search(question: str, k: int = 30, concerne: str | None = None) -> dict:
    q_emb = embeddings.embed([question], is_query=True)[0]

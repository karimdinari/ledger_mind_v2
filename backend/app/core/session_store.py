...
def delete_session(session_id: str) -> bool:
    _ensure_schema()
    with _lock:
        res = sessions_collection().delete_one({"id": session_id})
...
async def async_rename_session(session_id: str, title: str) -> bool:
    return await asyncio.to_thread(rename_session, session_id, title)
